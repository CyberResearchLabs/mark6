\section{rtcp.h File Reference}
\label{rtcp_8h}\index{rtcp.h@{rtcp.h}}
...
\index{rtcp.h@{rtcp.h}!init_seq@{init\_\-seq}}
\index{init_seq@{init\_\-seq}!rtcp.h@{rtcp.h}}
...
\index{rtcp.h@{rtcp.h}!on_expire@{on\_\-expire}}
\index{on_expire@{on\_\-expire}!rtcp.h@{rtcp.h}}
...
\index{rtcp.h@{rtcp.h}!on_receive@{on\_\-receive}}
\index{on_receive@{on\_\-receive}!rtcp.h@{rtcp.h}}
...
\index{rtcp.h@{rtcp.h}!rtcp_add_member@{rtcp\_\-add\_\-member}}
\index{rtcp_add_member@{rtcp\_\-add\_\-member}!rtcp.h@{rtcp.h}}
...
\index{rtcp.h@{rtcp.h}!rtcp_add_sender@{rtcp\_\-add\_\-sender}}
\index{rtcp_add_sender@{rtcp\_\-add\_\-sender}!rtcp.h@{rtcp.h}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}int rtcp\_\-add\_\-sender ({\bf rtcp\_\-session\_\-t} $\ast$ {\em s}, {\bf rtcp\_\-packet\_\-t} $\ast$ {\em p})\hspace{0.3cm}{\tt  [static]}}\label{rtcp_8h_a8}
...
\index{rtcp.h@{rtcp.h}!rtcp_destroy@{rtcp\_\-destroy}}
\index{rtcp_destroy@{rtcp\_\-destroy}!rtcp.h@{rtcp.h}}
...
\index{rtcp.h@{rtcp.h}!rtcp_earliest_event@{rtcp\_\-earliest\_\-event}}
\index{rtcp_earliest_event@{rtcp\_\-earliest\_\-event}!rtcp.h@{rtcp.h}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}gpointer rtcp\_\-earliest\_\-event ({\bf rtcp\_\-session\_\-t} $\ast$ {\em s}, gpointer {\em t})}\label{rtcp_8h_a18}
...
\index{rtcp.h@{rtcp.h}!rtcp_get_sender@{rtcp\_\-get\_\-sender}}
\index{rtcp_get_sender@{rtcp\_\-get\_\-sender}!rtcp.h@{rtcp.h}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}{\bf rtcp\_\-member\_\-t}$\ast$ rtcp\_\-get\_\-sender ({\bf rtcp\_\-session\_\-t} $\ast$ {\em s}, const u\_\-int32\_\-t $\ast$ {\em ssrc})\hspace{0.3cm}{\tt  [static]}}\label{rtcp_8h_a10}


\index{rtcp.h@{rtcp.h}!rtcp_init@{rtcp\_\-init}}
\index{rtcp_init@{rtcp\_\-init}!rtcp.h@{rtcp.h}}
...
\index{rtcp.h@{rtcp.h}!rtcp_interval@{rtcp\_\-interval}}
\index{rtcp_interval@{rtcp\_\-interval}!rtcp.h@{rtcp.h}}
...
\index{rtcp.h@{rtcp.h}!rtcp_new_member@{rtcp\_\-new\_\-member}}
\index{rtcp_new_member@{rtcp\_\-new\_\-member}!rtcp.h@{rtcp.h}}
...
\index{rtcp.h@{rtcp.h}!rtcp_new_sender@{rtcp\_\-new\_\-sender}}
\index{rtcp_new_sender@{rtcp\_\-new\_\-sender}!rtcp.h@{rtcp.h}}
...
\index{rtcp.h@{rtcp.h}!rtcp_on_expire@{rtcp\_\-on\_\-expire}}
\index{rtcp_on_expire@{rtcp\_\-on\_\-expire}!rtcp.h@{rtcp.h}}
...
\index{rtcp.h@{rtcp.h}!rtcp_on_receive@{rtcp\_\-on\_\-receive}}
\index{rtcp_on_receive@{rtcp\_\-on\_\-receive}!rtcp.h@{rtcp.h}}
...
\index{rtcp.h@{rtcp.h}!rtcp_packet_seq@{rtcp\_\-packet\_\-seq}}
\index{rtcp_packet_seq@{rtcp\_\-packet\_\-seq}!rtcp.h@{rtcp.h}}
...
\index{rtcp.h@{rtcp.h}!rtcp_packet_ssrc@{rtcp\_\-packet\_\-ssrc}}
\index{rtcp_packet_ssrc@{rtcp\_\-packet\_\-ssrc}!rtcp.h@{rtcp.h}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}u\_\-int32\_\-t rtcp\_\-packet\_\-ssrc ({\bf rtcp\_\-packet\_\-t} $\ast$ {\em p})\hspace{0.3cm}{\tt  [static]}}\label{rtcp_8h_a25}


\index{rtcp.h@{rtcp.h}!rtcp_packet_type@{rtcp\_\-packet\_\-type}}
\index{rtcp_packet_type@{rtcp\_\-packet\_\-type}!rtcp.h@{rtcp.h}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}{\bf rtcp\_\-packet\_\-type\_\-t} rtcp\_\-packet\_\-type ({\bf rtcp\_\-packet\_\-t} $\ast$ {\em p})\hspace{0.3cm}{\tt  [static]}}\label{rtcp_8h_a24}
...
\index{rtcp.h@{rtcp.h}!rtcp_received_packet_size@{rtcp\_\-received\_\-packet\_\-size}}
\index{rtcp_received_packet_size@{rtcp\_\-received\_\-packet\_\-size}!rtcp.h@{rtcp.h}}
...
\index{rtcp.h@{rtcp.h}!rtcp_remove_member@{rtcp\_\-remove\_\-member}}
\index{rtcp_remove_member@{rtcp\_\-remove\_\-member}!rtcp.h@{rtcp.h}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}int rtcp\_\-remove\_\-member ({\bf rtcp\_\-session\_\-t} $\ast$ {\em s}, {\bf rtcp\_\-packet\_\-t} $\ast$ {\em p})\hspace{0.3cm}{\tt  [static]}}\label{rtcp_8h_a7}
...
\begin{Desc}
\item[Returns:]1: on success, 0: otherwise. \end{Desc}
\index{rtcp.h@{rtcp.h}!rtcp_remove_sender@{rtcp\_\-remove\_\-sender}}
\index{rtcp_remove_sender@{rtcp\_\-remove\_\-sender}!rtcp.h@{rtcp.h}}
...
\index{rtcp.h@{rtcp.h}!rtcp_reschedule@{rtcp\_\-reschedule}}
\index{rtcp_reschedule@{rtcp\_\-reschedule}!rtcp.h@{rtcp.h}}
...
\index{rtcp.h@{rtcp.h}!rtcp_schedule@{rtcp\_\-schedule}}
\index{rtcp_schedule@{rtcp\_\-schedule}!rtcp.h@{rtcp.h}}
...
\index{rtcp.h@{rtcp.h}!rtcp_send_bye_packet@{rtcp\_\-send\_\-bye\_\-packet}}
\index{rtcp_send_bye_packet@{rtcp\_\-send\_\-bye\_\-packet}!rtcp.h@{rtcp.h}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}int rtcp\_\-send\_\-bye\_\-packet ({\bf rtcp\_\-session\_\-t} $\ast$ {\em s}, {\bf rtcp\_\-event\_\-t} {\em e})}\label{rtcp_8h_a3}


\index{rtcp.h@{rtcp.h}!rtcp_send_rtcp_report@{rtcp\_\-send\_\-rtcp\_\-report}}
\index{rtcp_send_rtcp_report@{rtcp\_\-send\_\-rtcp\_\-report}!rtcp.h@{rtcp.h}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}int rtcp\_\-send\_\-rtcp\_\-report ({\bf rtcp\_\-session\_\-t} $\ast$ {\em s}, {\bf rtcp\_\-event\_\-t} {\em e})}\label{rtcp_8h_a2}


\index{rtcp.h@{rtcp.h}!rtcp_sent_packet_size@{rtcp\_\-sent\_\-packet\_\-size}}
\index{rtcp_sent_packet_size@{rtcp\_\-sent\_\-packet\_\-size}!rtcp.h@{rtcp.h}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}int rtcp\_\-sent\_\-packet\_\-size ({\bf rtcp\_\-event\_\-t} {\em e})\hspace{0.3cm}{\tt  [static]}}\label{rtcp_8h_a22}


\index{rtcp.h@{rtcp.h}!rtcp_type_of_event@{rtcp\_\-type\_\-of\_\-event}}
\index{rtcp_type_of_event@{rtcp\_\-type\_\-of\_\-event}!rtcp.h@{rtcp.h}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}{\bf rtcp\_\-event\_\-type\_\-t} rtcp\_\-type\_\-of\_\-event ({\bf rtcp\_\-event\_\-t} {\em e})\hspace{0.3cm}{\tt  [static]}}\label{rtcp_8h_a23}


\index{rtcp.h@{rtcp.h}!update_seq@{update\_\-seq}}
\index{update_seq@{update\_\-seq}!rtcp.h@{rtcp.h}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}int update\_\-seq ({\bf source} $\ast$ {\em s}, u\_\-int16\_\-t {\em seq})\hspace{0.3cm}{\tt  [static]}}\label{rtcp_8h_a12}
