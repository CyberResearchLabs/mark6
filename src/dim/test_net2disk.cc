...
#include <test_net2disk.h>

using namespace boost;
using namespace boost::interprocess;
namespace bf = boost::filesystem;

CPPUNIT_TEST_SUITE_REGISTRATION (TestNet2Disk);


void
TestNet2Disk::setUp (void)
{
  // set up test environment (initializing objects)
}

void
TestNet2Disk::tearDown (void)
{
}

void
TestNet2Disk::basic(void)
{
  std::cout << "TestNet2Disk::basic()" << std::endl;
