...
command_response_mapping() ->
    [
     {vsis_cmd_disk_state(),      m6_resp_set_volume_state()},
     {vsis_cmd_disk_state_mask(), m6_resp_set_volume_state_mask()},
     {vsis_cmd_input_stream(),    m6_resp_set_input_stream()},
     {vsis_cmd_msn(),             m6_resp_set_module_serial_number()},
     {vsis_cmd_record(),          m6_resp_set_record()},
     {vsis_cmd_vol_def(),         m6_resp_define_volume()},
     {vsis_cmd_vol_action(),      m6_resp_set_volume_action()},
     {vsis_cmd_disk_state(),      m6_resp_get_volume_state()},
     {vsis_cmd_disk_state_mask(), m6_resp_set_volume_action()},
     {vsis_qry_disk_state(),      m6_resp_get_volume_state()},
     {vsis_qry_disk_state_mask(), m6_resp_get_volume_state_mask()},
     {vsis_qry_input_stream(),    m6_resp_get_input_stream()},
     {vsis_qry_msn(),             m6_resp_get_module_serial_number()},
     {vsis_qry_record(),          m6_resp_get_record_status()},
     {vsis_qry_vol_def(),         m6_resp_get_volume_info()},
     {vsis_qry_data_check(),      m6_resp_check_data()},
     {vsis_qry_disk_model(),      m6_resp_get_disk_data()},
     {vsis_qry_disk_serial(),     m6_resp_get_disk_data()},
     {vsis_qry_disk_size(),       m6_resp_get_disk_data()},
     {vsis_qry_disk_perf(),       m6_resp_get_disk_performance()},
     {vsis_qry_dts_id(),          m6_resp_get_recorder_info()},
     {vsis_qry_status(),          m6_resp_get_system_status()},
     {vsis_qry_rtime(),           m6_resp_get_volume_usage()},
     {vsis_qry_vol_usage(),       m6_resp_get_volume_usage()}
    ].
...
m6_resp_set_volume_state()->
    #m6_resp{name="set_volume_state", retval="ok", reason="Rsn",
	      params=[#param{name="volumeName", type="string", value="VOL1"}]}.

m6_resp_set_volume_state_mask()->
    #m6_resp{name="set_volume_state_mask", retval="ok", reason="Rsn",
	      params=[#param{name="volumeName", type="string", value="VOL1"}]}.

m6_resp_set_input_stream()->
    #m6_resp{name="set_input_stream", retval="ok", reason="Rsn",
	      params=[]}.

m6_resp_set_module_serial_number()->
    #m6_resp{name="set_module_serial_number", retval="ok", reason="Rsn",
	      params=[#param{name="msn", type="string", value="MSN1"},
		      #param{name="volumeName", type="string", value="VOL1"}]}.

m6_resp_set_record()->
    #m6_resp{name="set_record", retval="ok", reason="Rsn",
	      params=[]}.

m6_resp_define_volume()->
    #m6_resp{name="define_volume", retval="ok", reason="Rsn",
	      params=[]}.

m6_resp_set_volume_action()->
    #m6_resp{name="set_volume_action", retval="ok", reason="Rsn",
	      params=[]}.

m6_resp_get_volume_state()->
    #m6_resp{name="get_volume_state", retval="ok", reason="Rsn",
	      params=[#param{name="volumeName", type="string", value="VOL1"},
		      #param{name="dsmStatus", type="keyword", value="recorded"}]}.

m6_resp_get_volume_state_mask()->
						% Check this command return.
    #m6_resp{name="get_volume_state_mask", retval="ok", reason="Rsn",
	      params=[#param{name="volumeName", type="string", value="VOL1"}]}.

m6_resp_get_input_stream()->
    #m6_resp{name="get_input_stream", retval="ok", reason="Rsn",
...
m6_resp_get_module_serial_number()->
    #m6_resp{name="get_module_serial_number", retval="ok", reason="Rsn",
	      params=[#param{name="MSN", type="string", value="MSN1"},
		      #param{name="volumeName", type="string", value="VOL1"},
		      #param{name="MSNCount", type="unsigned", value="MSN1"}]}.

m6_resp_get_record_status()->
    #m6_resp{name="get_record_status", retval="ok", reason="Rsn",
...
m6_resp_get_volume_info()->
    #m6_resp{name="get_volume_info", retval="ok", reason="Rsn",
	      params=[#param{name="volumeName", type="string", value="VOL1"},
		      #param{name="volumeCont", type="unsigned", value="8"},
		      #param{name="phyVolumeName", type="string", value="PVOL1"}]}.

m6_resp_check_data()->
    #m6_resp{name="check_data", retval="ok", reason="Rsn",
...
m6_resp_get_disk_data()->
    #m6_resp{name="get_disk_data", retval="ok", reason="Rsn",
...
m6_resp_get_disk_performance()->
    #m6_resp{name="get_disk_performance", retval="ok", reason="Rsn",
	      params=[#param{name="diskCount", type="unsigned", value="8"},
		      #param{name="volumeName", type="string", value="VOL1"},
		      #param{name="volumeSerial", type="string", value="VSN1"},
		      #param{name="volumePerformance", type="unsigned", value="9"},
...
m6_resp_get_recorder_info()->
    #m6_resp{name="get_recorder_info", retval="ok", reason="Rsn",
...
m6_resp_get_system_status()->
    #m6_resp{name="get_system_status", retval="ok", reason="Rsn",
...
m6_resp_get_volume_usage()->
    #m6_resp{name="get_volume_usage", retval="ok", reason="Rsn",
